...
class JajarGenjangScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        layout.add_widget(Label(
            text="HITUNG LUAS JAJAR GENJANG",
            font_name="MondayTuesdayDemo.otf",
            font_size=sp(23),
            color=(0.23, 0.62, 0.43, 1),
            size_hint_y=0.1,
            height=dp(60), 
            halign="center",
            valign="middle"
        ...
        btn_back = Button(
            ...
            size_hint=(None, None),
            size=(dp(120), dp(50)),
            background_color=(0.23, 0.62, 0.43, 1),
            background_normal="",
            background_down="",
    ...
    def hitung_luas(self, instance):
        try:
            a = float(self.inputAlas.text)
            t = float(self.inputTinggi.text)
            luas = a * t 
            self.label_hasil.text = f"Luas Jajar Genjang: {luas:.2f}"
            self.label_hasil.color = (0, 0, 0, 1)

            self.simpan_data(a, t, luas)
