...
class PersegiScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        layout.add_widget(self.inputSisi)
        ...
        btn_back = Button(
            ...
            size_hint=(None, None),
            size=(dp(120), dp(50)),
            background_color=(0.82, 0.67, 0.47, 1),
            background_normal="",
            background_down="",
    ...
    def hitung_luas(self, instance):
        try:
            s = float(self.inputSisi.text)
            luas = s * s
            self.label_hasil.text = f"Luas Persegi: {luas:.2f}"
            self.label_hasil.color = (0, 0, 0, 1)

            self.simpan_data(s, luas)
