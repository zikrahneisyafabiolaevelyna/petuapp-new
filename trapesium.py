...
class TrapesiumScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        btn_back = Button(
            ...
            size_hint=(None, None),
            size=(dp(120), dp(50)),
            background_color=(0.953, 0.737, 0.180, 1),
            background_normal="",
            background_down="",
